...
class LanguageMiddleware:
    ...
    def __call__(self, request):
        ...
        print(f"[LanguageMiddleware] Session: {language_session}, Cookie: {language_cookie}, Using: {language}")
        ...
        if language in ['en', 'it']:
            ...
            print(f"[LanguageMiddleware] Test: 'Approved'='{test_approved}', 'Discard'='{test_discard}'")
        else:
            # Fallback to English
