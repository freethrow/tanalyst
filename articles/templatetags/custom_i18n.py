...
TRANSLATIONS = {
    "it": {
        ...
        "Opportunities for Italian Companies": "Opportunità per le Aziende Italiane",
        ...
        "Search articles using hybrid, semantic, or keyword search modes": "Cerca articoli utilizzando modalità di ricerca ibrida, semantica o per parole chiave",
        "Search Mode": "Modalità di Ricerca",
        "Hybrid": "Ibrida",
        "Best": "Migliore",
        "Semantic Only": "Solo Semantica",
        "Keyword Only": "Solo Parole Chiave",
        "Enable Reranking": "Abilita Riordino",
        "Slower but more accurate": "Più lento ma più preciso",
        "Search Modes Explained": "Modalità di Ricerca Spiegate",
        "Combines keyword matching and semantic similarity for best results": "Combina la corrispondenza delle parole chiave e la somiglianza semantica per i migliori risultati",
        "Finds articles with similar meaning, even if words differ": "Trova articoli con significato simile, anche se le parole sono diverse",
        "Traditional search based on exact word matches": "Ricerca tradizionale basata su corrispondenze esatte di parole",
        "Show raw data": "Mostra dati grezzi",
        "Hide raw data": "Nascondi dati grezzi",
        "Full Search Results": "Risultati di Ricerca Completi",
    },
    "en": {
        "Home": "Home",
        "Approved": "Approved",
        ...
        "Search articles using hybrid, semantic, or keyword search modes": "Search articles using hybrid, semantic, or keyword search modes",
        "Search Mode": "Search Mode",
        "Hybrid": "Hybrid",
        "Best": "Best",
        "Semantic Only": "Semantic Only",
        "Keyword Only": "Keyword Only",
        "Enable Reranking": "Enable Reranking",
        "Slower but more accurate": "Slower but more accurate",
        "Search Modes Explained": "Search Modes Explained",
        "Combines keyword matching and semantic similarity for best results": "Combines keyword matching and semantic similarity for best results",
        "Finds articles with similar meaning, even if words differ": "Finds articles with similar meaning, even if words differ",
        "Traditional search based on exact word matches": "Traditional search based on exact word matches",
        "Show raw data": "Show raw data",
        "Hide raw data": "Hide raw data",
        "Full Search Results": "Full Search Results",
    },
}
